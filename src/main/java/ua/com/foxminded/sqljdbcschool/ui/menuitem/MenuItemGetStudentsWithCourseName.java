...
public class MenuItemGetStudentsWithCourseName extends MenuItem {
    private StudentService service;
    private Scanner scanner;

    public MenuItemGetStudentsWithCourseName(String name,
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        MenuItemGetStudentsWithCourseName other = (MenuItemGetStudentsWithCourseName) obj;

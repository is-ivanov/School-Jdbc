...
public class MenuItemAddNewStudent extends MenuItem {
    ...
    public MenuItemAddNewStudent(String name, StudentService service,
            Scanner scanner) {
        super(name);
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        MenuItemAddNewStudent other = (MenuItemAddNewStudent) obj;
